...
class PointMLP(nn.Module):
    ...
    def __init__(self, num_classes=50,points=16000, embed_dim=64, groups=1, res_expansion=1.0,
        ...
        self.embedding = ConvBNReLU1D(24, embed_dim, bias=bias, activation=activation)
...
#def pointMLP_seg(num_classes=50, **kwargs) -> PointMLP:
def pointMLP_seg(num_classes=8, num_channels=24, **kwargs) -> PointMLP:
