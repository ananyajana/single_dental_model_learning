...
class Pointnet2_seg(nn.Module):
    def __init__(self, num_classes, normal_channel=False):
        ...
        if normal_channel:
            ...
            # making this change to accomodate our mesh cells which are summarized by 3 cell vertices, cell center and 
            # a normal vector
    ...
    def forward(self, xyz, cls_label):
        ...
        if self.normal_channel:
            l0_points = xyz
            #l0_xyz = xyz[:,:3,:]
            # making this change to accomodate our mesh cells
            l0_xyz = xyz[:,9:12,:]
        else:
            l0_points = xyz
            l0_xyz = xyz
