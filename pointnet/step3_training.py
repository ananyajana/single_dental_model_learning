...
previous_check_point_path = './models_22jan'
...
num_channels = 24 #number of features
#num_epochs = 200
num_epochs = 400
num_workers = 0
#train_batch_size = 10
...
#criterion = F.nll_loss(pred, target, weight=weight)
...
for epoch in range(num_epochs):
    ...
    for i_batch, batched_sample in enumerate(train_loader):
        ...
        #print('labels: ', batched_sample['labels'])
