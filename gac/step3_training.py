...
for epoch in range(num_epochs):
    ...
    for i_batch, batched_sample in enumerate(train_loader):
        ...
        #print('1111 inputs.requires_grad: ', inputs.requires_grad)
        #print('1111 labels.requires_grad: ', labels.requires_grad)
        ...
        #print('1111 loss: ', loss)
        #print('1111 loss.is_leaf: ', loss.is_leaf)
        #print('1111 loss.requires_grad: ', loss.requires_grad)
